    ...
    <div class="row g-4">
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm text-center">
                <img src="{{ asset('images/caja-bull.jpeg') }}" class="card-img-top p-3" alt="Paleta Hombre">
                <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm text-center">
                <img src="{{ asset('images/caja-penn.jpeg') }}" class="card-img-top p-3" alt="Paleta Hombre">
                <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm text-center">
                <img src="{{ asset('images/caja-xtrust.jpeg') }}" class="card-img-top p-3" alt="Paleta Hombre">
                <div class="card-body">
